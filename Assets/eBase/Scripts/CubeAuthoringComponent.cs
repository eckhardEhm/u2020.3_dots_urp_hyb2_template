...
public class CubeAuthoringComponent : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        dstManager.AddComponentData(    entity, new Unity.Transforms.Translation    { Value = etransform});
        dstManager.AddComponentData(    entity, new Unity.Transforms.Rotation       { Value = rotation});
